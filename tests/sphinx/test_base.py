...
class TestSphinx(unittest.TestCase):
    ...
    def test_write_input(self):
        ...
        self.sphinx._create_working_directory()
        self.sphinx.input["VaspPot"] = False
        self.sphinx.structure.add_tag(selective_dynamics=(True, True, True))
        self.sphinx.structure.selective_dynamics[1] = (False, False, False)
        self.sphinx.calc_static()
        self.sphinx.fix_symmetry = False
        self.sphinx.write_input()
        file_content = [
            '//job_sphinx\n',
